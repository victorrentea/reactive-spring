...
////          })
//          .doOnNext(request -> {
//             pendingConnections.get(getRequestId(message)).tryEmitValue(convertToResponseOnQueue(message));
//          })
...
//
//
//   Map<String, One<CustomResponseOnQueue>> pendingConnections = new HashMap<>(); // careful with memory. You need to remove from the map
//
...
////      pendingConnections.put(requestId, oneShotPublisher);
//
//
