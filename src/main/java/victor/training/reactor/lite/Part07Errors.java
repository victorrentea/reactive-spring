...
//========================================================================================
	...
	// TODO Return a Flux<User> containing User.SAUL and User.JESSE when
	//  an error occurs in the input Flux, else do not change the input Flux.
...
//========================================================================================
	...
	Flux<User> capitalizeMany(Flux<User> flux) {
		return flux.flatMap(user -> Mono.fromCallable(() -> capitalizeUser(user)));
			// imperative/defensive thinking:
//			.flatMap(user -> {
//			try {
