...
//========================================================================================
	...
	public void howToHackTime(Supplier<Flux<Long>> supplier) {
	    // TODO hack GLOBAL TIME (on thread local)
		try {
//			create Flux with hacked time
			Flux<Long> longFlux = supplier.get();
		} finally {
			// TODO unhack global time
		}
	}
