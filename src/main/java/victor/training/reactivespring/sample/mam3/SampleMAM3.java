...
//   @DetailedItemInfoByMiraklIdSwagger
   ...
   private Mono<ResponseEntity<ItemInfoResponse>> generateResponse(List<Object> itemsWithInfo, MultiSet<String> miraklIds, HashSet<String> itemsOnError, Object o) {
      return null;
   }

   private Object mapDetailedItemInfo(Object t1, Object t2) {
      return null;
   }
